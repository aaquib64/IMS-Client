...
function AddProducts() {
  ...
  const { _id } = useParams(); // Assuming you want to update a product with this ID
  ...
  useEffect(() => {
    axios
      .get(`https://ims-server-r467.onrender.com/list/${_id}`)
      .then((result) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://ims-server-r467.onrender.com/update/${_id}`,
        formData
      );
